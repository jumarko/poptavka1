...
public class EncryptorAspectTest extends BasicIntegrationTest {
    ...
    private com.eprovement.poptavka.application.security.Encryptor encryptor;
    ...
    /**
     * Test whether {@link com.eprovement.poptavka.application.security.aspects.EncryptorAspect} has NOT been applied
     * to the method that is NOT annotated with {@link com.eprovement.poptavka.application.security.aspects.Encrypted}.
     * @throws Exception
     */
    @Test
