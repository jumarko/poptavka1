...
public class AdminPreferencesView extends Composite implements AdminPreferencesPresenter.AdminPreferencesInterface {
    ...
    //*************************************************************************/
    //Table constants
    private static final String KEY_COL_WIDTH = "20%";
    private static final String VALUE_COL_WIDTH = "20%";
    ...
    private void initDataGrid() {
        ...
        // TABLE
        dataGrid = new UniversalAsyncGrid<PreferenceDetail>(KEY_PROVIDER, initSort());
