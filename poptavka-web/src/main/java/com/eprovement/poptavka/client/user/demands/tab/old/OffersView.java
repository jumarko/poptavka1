...
import com.eprovement.poptavka.client.user.widget.grid.unused.GlobalDemandOfferTable;
import com.eprovement.poptavka.client.user.widget.grid.unused.SingleDemandOfferTable;
