 ...
 */
public class IntegerBox extends IntegerBoxBase {
     ...
     */
    public static IntegerBox wrap(Element element) {
        // Assert that the element is attached.
        assert Document.get().getBody().isOrHasChild(element);

        IntegerBox textBox = new IntegerBox(element);
     ...
     */
    public IntegerBox() {
        this(Document.get().createTextInputElement(), "gwt-IntegerTextBox");
    }
    ...
    IntegerBox(Element element, String styleName) {
        super(element);
        if (styleName != null) {
