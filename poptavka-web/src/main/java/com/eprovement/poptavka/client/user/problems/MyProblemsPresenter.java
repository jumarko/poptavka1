...
//            m1.setId(1L);
        ...
        MessageDetail m2 = new MessageDetail();
...
//            m2.setId(2L);
        ...
        MessageDetail m3 = new MessageDetail();
...
//            m3.setId(3L);
        m3.setBody("I hate windows. I wanted place some japanese text here "
                ...
                + "So wtf???!!!");
        MessageDetail m4 = new MessageDetail();
