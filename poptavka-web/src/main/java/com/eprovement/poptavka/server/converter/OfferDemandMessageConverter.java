...
public class OfferDemandMessageConverter extends AbstractConverter<UserMessage, OfferDemandMessage> {
    @Override
...
//        m.setReceiverId();
    ...
    @Override
    public UserMessage converToSource(OfferDemandMessage offerDemandMessage) {
