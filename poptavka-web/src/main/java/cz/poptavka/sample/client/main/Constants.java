...
public final class Constants {
    ...
    // User
    public static final int USER_DEMANDS = 4;
    public static final int USER_MESSAGES = 5;
    public static final int USER_ADMINISTRATION = 6;

    /* Home demands module */
    public static final int HOME_DEMANDS = 7;
    /* Home suppliers module */
    public static final int HOME_SUPPLIERS = 8;
