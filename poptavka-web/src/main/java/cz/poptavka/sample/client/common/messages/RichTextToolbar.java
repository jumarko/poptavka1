...
public class RichTextToolbar extends Composite {
    ...
    private static final String CSS_ROOT_NAME = "RichTextToolbar.css";
    ...
    private class EventHandler implements ClickHandler, KeyUpHandler,
        ...
        public void onClick(ClickEvent event) {
            ...
            this.onClickSecond(event);
        }

        public void onClickSecond(ClickEvent event) {
            if (event.getSource().equals(bold)) {
    ...
    private void buildTools() {
        ...
        bold = createToggleButton(HTTP_STATIC_ICONS_GIF, 0, 0, 20, 20,
                GUI_HOVERTEXT_BOLD);
        topPanel.add(bold);
        italic = createToggleButton(HTTP_STATIC_ICONS_GIF, 0, 60, 20, 20,
                GUI_HOVERTEXT_ITALIC);
        topPanel.add(italic);
        underline = createToggleButton(HTTP_STATIC_ICONS_GIF, 0, 140, 20, 20,
                GUI_HOVERTEXT_UNDERLINE);
        topPanel.add(underline);
        stroke = createToggleButton(HTTP_STATIC_ICONS_GIF, 0, 120, 20, 20,
                GUI_HOVERTEXT_STROKE);
        topPanel.add(stroke);
        topPanel.add(new HTML("&nbsp;"));
        subscript = createToggleButton(HTTP_STATIC_ICONS_GIF, 0, 600, 20, 20,
                GUI_HOVERTEXT_SUBSCRIPT);
        topPanel.add(subscript);
        superscript = createToggleButton(HTTP_STATIC_ICONS_GIF, 0, 620, 20, 20,
                GUI_HOVERTEXT_SUPERSCRIPT);
        topPanel.add(superscript);
        topPanel.add(new HTML("&nbsp;"));
        alignleft = createPushButton(HTTP_STATIC_ICONS_GIF, 0, 460, 20, 20,
                GUI_HOVERTEXT_ALIGNLEFT);
        topPanel.add(alignleft);
        alignmiddle = createPushButton(HTTP_STATIC_ICONS_GIF, 0, 420, 20, 20,
                GUI_HOVERTEXT_ALIGNCENTER);
        topPanel.add(alignmiddle);
        alignright = createPushButton(HTTP_STATIC_ICONS_GIF, 0, 480, 20, 20,
                GUI_HOVERTEXT_ALIGNRIGHT);
        topPanel.add(alignright);
        topPanel.add(new HTML("&nbsp;"));
        orderlist = createPushButton(HTTP_STATIC_ICONS_GIF, 0, 80, 20, 20,
                GUI_HOVERTEXT_ORDERLIST);
        topPanel.add(orderlist);
        unorderlist = createPushButton(HTTP_STATIC_ICONS_GIF, 0, 20, 20, 20,
                GUI_HOVERTEXT_UNORDERLIST);
        topPanel.add(unorderlist);
        indentright = createPushButton(HTTP_STATIC_ICONS_GIF, 0, 400, 20, 20,
                GUI_HOVERTEXT_IDENTRIGHT);
        topPanel.add(indentright);
        indentleft = createPushButton(HTTP_STATIC_ICONS_GIF, 0, 540, 20, 20,
                GUI_HOVERTEXT_IDENTLEFT);
        topPanel.add(indentleft);
        topPanel.add(new HTML("&nbsp;"));
        generatelink = createPushButton(HTTP_STATIC_ICONS_GIF, 0, 500, 20, 20,
                GUI_HOVERTEXT_LINK);
        topPanel.add(generatelink);
        breaklink = createPushButton(HTTP_STATIC_ICONS_GIF, 0, 640, 20, 20,
                GUI_HOVERTEXT_BREAKLINK);
        topPanel.add(breaklink);
        topPanel.add(new HTML("&nbsp;"));
        insertline = createPushButton(HTTP_STATIC_ICONS_GIF, 0, 360, 20, 20,
                GUI_HOVERTEXT_HLINE);
        topPanel.add(insertline);
        insertimage = createPushButton(HTTP_STATIC_ICONS_GIF, 0, 380, 20, 20,
                GUI_HOVERTEXT_IMAGE);
        topPanel.add(insertimage);
        topPanel.add(new HTML("&nbsp;"));
        removeformatting = createPushButton(HTTP_STATIC_ICONS_GIF, 20, 460, 20,
                20, GUI_HOVERTEXT_REMOVEFORMAT);
        topPanel.add(removeformatting);
        topPanel.add(new HTML("&nbsp;"));
        texthtml = createToggleButton(HTTP_STATIC_ICONS_GIF, 0, 260, 20, 20,
