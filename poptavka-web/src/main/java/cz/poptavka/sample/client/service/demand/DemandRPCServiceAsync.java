...
public interface DemandRPCServiceAsync {
    ...
    void getDemands(Category[] categories, AsyncCallback<List<DemandDetailForDisplayDemands>> callback);

    void getDemands(Locality[] localities, AsyncCallback<List<DemandDetailForDisplayDemands>> callback);

    void getDemands(ResultCriteria resultCriteria, AsyncCallback<List<DemandDetailForDisplayDemands>> callback);

    void getDemands(ResultCriteria resultCriteria, Category[] categories,
            AsyncCallback<List<DemandDetailForDisplayDemands>> callback);
    ...
    void getClientDemands(long id, AsyncCallback<ArrayList<DemandDetailForDisplayDemands>> callback);
